...
async def startup_event():
    ...
    # Use standard subprocess.Popen instead of asyncio to avoid Windows NotImplementedError
    ...
    # Start reader thread
    threading.Thread(target=read_engine_output, args=(engine_process, loop, engine_output_queue), daemon=True).start()
...
app.mount("/", StaticFiles(directory=os.path.join(os.path.dirname(os.path.dirname(__file__)), 'ui'), html=True), name="ui")
